...
def top_rate(request):
    highest_rates = DepositOptions.objects.values('product').annotate(max_rate=Max('intr_rate2'))
    highest_rate_option = DepositOptions.objects.get(intr_rate2=highest_rates[0]['max_rate'])
